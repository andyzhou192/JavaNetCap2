...
public class PropertyHelper {
	...
	public static String NET_DEVICES_INDEX = "netDevicesIndex";
	...
	/************************* Jcapture Setting View *************************/
	public static void setNetDevicesIndex(int index){
		Constants.PROPS.put(NET_DEVICES_INDEX, index);
		prop.put(NET_DEVICES_INDEX, index);
	...
	/************************* Jcapture Setting View *************************/
	public static int getNetDevicesIndex(){
		if(null == Constants.PROPS)
			PropertyHelper.loadProperties();
		String value = String.valueOf(Constants.PROPS.get(NET_DEVICES_INDEX));
		return (StringUtil.validate(value)) ? Integer.valueOf(value) : 0;
	}
