...
public class ArrayUtil {
	...
	// public static byte[] arrayReplace(byte[] org, byte[] search, byte[]
	// replace, int startIndex) throws UnsupportedEncodingException {
	...
	// KMPMatcher kmpMatcher = new
	// com.taobao.sketch.util.ArrayUtil.KMPMatcher();
