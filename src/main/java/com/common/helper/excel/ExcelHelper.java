...
public abstract class ExcelHelper {
     ...
     * @throws Exception
     */
    public <T> List<T> readExcel(Class<T> clazz, boolean hasTitle)
            throws Exception {
        ...
        return readExcel(clazz, fieldNames, hasTitle);
    }
     ...
     * @throws Exception
     */
    public abstract <T> List<T> readExcel(Class<T> clazz, String[] fieldNames, boolean hasTitle) throws Exception;
